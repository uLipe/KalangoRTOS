# WARNING: THIS IS AN OLD CODE THAT IS NOT MAITAINED ANYMORE, FOR YEARS THIS PROJECT WAS MY EXPERIMENTAL BENCH TO UNDERSTAND THE INTERNALS OF EMBEDDED SYSTEMS OS, AND NOW IT WILL BE REPLACED BY ANOTHER PROJECT A MICROKERNEL THAT WILL BE PUT ON TOP OF THIS ONE, I'M PRESERVING THE COMMIT AND OLD STRUCTURE FOR HISTORICAL REASONS AND REFERENCES.
