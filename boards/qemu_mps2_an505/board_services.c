...
/*
 * Early peripheral-privilege bring-up (IoTKit SPCTRL / PPC unprivileged enable)
 * lives in board_init.c so it is linked even when the board service threads are
 * skipped (integration tests with ARCH_SKIP_BOARD_SVC=1).
 */
