...
/*
 * Board services — boards/qemu_mps2_an505/board_services.c
 *
 * Console IPC server (CMSDK APB UART0, polled TX).  Sleep uses the kernel
 * SysTick timing wheel via board_timer_sleep_us → ulmk_sleep_ms.
 */
