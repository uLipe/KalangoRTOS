...
set(UL_BOARD_CPU  "tc39xx")

# ── Compiler flags ────────────────────────────────────────────────────────────
# Consumed by tools/dev.py build (regex-parsed, no CMake expansion).
# -mcpu is NOT listed here — tools/dev.py derives it from UL_BOARD_CPU above.
...
if(DEFINED CMAKE_C_FLAGS)
    string(APPEND CMAKE_C_FLAGS          " -mcpu=${UL_BOARD_CPU}")
    string(APPEND CMAKE_ASM_FLAGS        " -mcpu=${UL_BOARD_CPU}")
    string(APPEND CMAKE_EXE_LINKER_FLAGS " -mcpu=${UL_BOARD_CPU}")
endif()
